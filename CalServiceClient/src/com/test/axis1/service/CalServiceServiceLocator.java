...
public class CalServiceServiceLocator extends org.apache.axis.client.Service implements com.test.axis1.service.CalServiceService {
    ...
    public com.test.axis1.service.CalService getCalService() throws javax.xml.rpc.ServiceException {
    ...
    public com.test.axis1.service.CalService getCalService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.test.axis1.service.CalServiceSoapBindingStub _stub = new com.test.axis1.service.CalServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.test.axis1.service.CalService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.test.axis1.service.CalServiceSoapBindingStub _stub = new com.test.axis1.service.CalServiceSoapBindingStub(new java.net.URL(CalService_address), this);
                _stub.setPortName(getCalServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.axis1.test.com", "CalServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.axis1.test.com", "CalService"));
        }
